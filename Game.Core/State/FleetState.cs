...
namespace Game.Core.State
{
    ...
    public class FleetState : GalaxyGameObjectState
    {
        ...
        public FleetState(ShipsContainer ships, long id,  NamedState namedState, FactionOwnedState factionOwnedState, PositionState positionState, StateActionState actionState) :
        base( id,  namedState, positionState, factionOwnedState, actionState)
        {
